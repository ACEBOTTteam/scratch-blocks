...
Blockly.Css.CONTENT = [
  ...
  '.injectionDiv {',
    'height: 100%;',
    'position: relative;',
    'overflow: hidden !important;', /* So blocks in drag surface disappear at edges */
  ...
  */
  ...
  '.scratchCategoryMenuRow:hover>.deleteScratchCategory {',
    'display:block;',
  '}',

  '.deleteScratchCategory {',
    'display:none;',
    'position:relative;',
    'pointer-events: none;',
  '}',

  '.deleteScratchCategory:after {',
     'content: "✖";',
     'position: absolute;',
     'top: 0px;',
     'right: 0px;',
     'font-size: 12px;',
     'color: white;',
     'background-color: hsl(219, 97%, 29%,.3);',
     'border-radius: 50%;',
     'width: 14px;',
     'height: 14px;',
     'display: flex;',

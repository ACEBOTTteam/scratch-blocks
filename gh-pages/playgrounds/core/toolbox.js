 ...
 * 更新删除区域提示覆盖面积
 */
Blockly.Toolbox.prototype.updataShadowSize = function() {
  if(this.isHideFlyout_){
    Blockly.utils.addClass(/** @type {!Element} */ (this.trash_), 'minToolBoX');
  }else{
    Blockly.utils.removeClass(/** @type {!Element} */ (this.trash_), 'minToolBoX');
  }
}
...
Blockly.Toolbox.prototype.setSelectedItem = function(item, opt_shouldScroll) {
  ...
  if (this.selectedItem_ != null) {
    ...
    if (this.isHideFlyout_) {
      ...
      this.updataShadowSize();//更新删除区域提示覆盖面积
      this.workspace_.resize();
    }
  }
};

...
Blockly.ScratchMsgs.locales["ar"] = {
    ...
    "ROBOT_HUMIDITY": "الرطوبة النسبية",
    ...
    "ROBOT_TRACE_SENSOR_SET": "مستشعر التتبع ضبط دبوس (R%1,M%2,L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "وحدة التعرف على الصوت RX %1 TX %2 تعرف على الجملة %3",
    ...
    "ROBOT_RELAY_MODULE": "وحدة التتابع %1 NC %2",
    "ROBOT_OLED_SET": "OLED تعيين حجم الخط %1",
    "ROBOT_OLED_STRING": "OLED x%1y%2 عرض السلسلة %3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2 عرض الرقم %3",
    "ROBOT_OLED_CLEAR": "مسح شاشة OLED",
...
Blockly.ScratchMsgs.locales["cs"] = {
    ...
    "ROBOT_HUMIDITY": "Relativní vlhkost",
    ...
    "ROBOT_TRACE_SENSOR_SET": "Nastavení pinů senzoru stopy (R%1, M%2, L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "Modul rozpoznávání hlasu RX %1 TX %2 rozpoznat výraz %3",
    ...
    "ROBOT_RELAY_MODULE": "Modul relé %1 NC %2",
    "ROBOT_OLED_SET": "OLED nastavit velikost písma %1",
    "ROBOT_OLED_STRING": "OLED x%1y%2 zobrazit řetězec %3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2 zobrazit číslo %3",
    "ROBOT_OLED_CLEAR": "Vyčistit obrazovku OLED",
...
Blockly.ScratchMsgs.locales["de"] = {
    ...
    "ROBOT_HUMIDITY": "Relative Luftfeuchtigkeit",
    ...
    "ROBOT_TRACE_SENSOR_SET": "Linienverfolgungssensor Pin-Konfiguration (R%1, M%2, L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "Spracherkennungsmodul RX %1 TX %2 erkennt Satz %3",
    ...
    "ROBOT_RELAY_MODULE": "Relaismodul %1 NC %2",
    "ROBOT_OLED_SET": "OLED Schriftgröße %1 einstellen",
    "ROBOT_OLED_STRING": "OLED x%1y%2 zeigt Zeichen %3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2 zeigt Nummer %3",
    "ROBOT_OLED_CLEAR": "OLED-Bildschirm löschen",
...
Blockly.ScratchMsgs.locales["en"] = {
    ...
    "ROBOT_TRACE_SENSOR_SET": "track sensor set the pin(R: %1,M: %2,L %3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "voice recognition TX %1 RX %2 password %3",
    ...
    "ROBOT_RELAY_MODULE": "relay %1 NC %2",
    "ROBOT_OLED_SET": "OLED set font size %1",
    "ROBOT_OLED_STRING": "OLED x %1 y %2 show string %3",
    "ROBOT_OLED_NUMBER": "OLED x %1 y %2 show number %3",
    "ROBOT_OLED_CLEAR": "OLCD clear screen",
...
Blockly.ScratchMsgs.locales["es"] = {
    ...
    "ROBOT_HUMIDITY": "Humedad relativa",
    ...
    "ROBOT_TRACE_SENSOR_SET": "Configuración de pin del sensor de rastreo (R%1, M%2, L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "Módulo de reconocimiento de voz RX %1 TX %2 reconocer frase %3",
    ...
    "ROBOT_RELAY_MODULE": "Módulo de relé %1 NC %2",
    "ROBOT_OLED_SET": "OLED ajustar tamaño de fuente %1",
    "ROBOT_OLED_STRING": "OLED x%1y%2 mostrar cadena %3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2 mostrar número %3",
    "ROBOT_OLED_CLEAR": "Limpiar pantalla OLED",
...
Blockly.ScratchMsgs.locales["fr"] = {
    ...
    "ROBOT_HUMIDITY": "humidité relative",
    ...
    "ROBOT_TRACE_SENSOR_SET": "capteur de suivi réglez les broches (R%1, M%2, L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "module de reconnaissance vocale RX %1 TX %2 phrase reconnue %3",
    ...
    "ROBOT_RELAY_MODULE": "module de relais %1 NC %2",
    "ROBOT_OLED_SET": "OLED définir la taille de la police %1",
    "ROBOT_OLED_STRING": "OLED x %1 y %2 afficher le caractère %3",
    "ROBOT_OLED_NUMBER": "OLED x %1 y %2 afficher le nombre %3",
    "ROBOT_OLED_CLEAR": "effacer l'écran OLED",
...
Blockly.ScratchMsgs.locales["ko"] = {
    ...
    "ROBOT_TRACE_SENSOR_SET": "트레이스 센서 핀 설정(R%1,M%2,L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "음성 인식 모듈 RX %1 TX %2 문장 인식 %3",
    ...
    "ROBOT_RELAY_MODULE": "릴레이 모듈 %1 NC %2",
    "ROBOT_OLED_SET": "OLED 글꼴 크기 설정 %1",
    "ROBOT_OLED_STRING": "OLED x%1y%2 문자열 %3 표시",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2 숫자 %3 표시",
    "ROBOT_OLED_CLEAR": "OLED 화면 지우기",
...
Blockly.ScratchMsgs.locales["hr"] = {
    ...
    "ROBOT_TEMPERATURE": "Temperatura",
    "ROBOT_HUMIDITY": "Relativna vlažnost",
    ...
    "ROBOT_TRACE_SENSOR_SET": "Postavi pinove senzora tragača (R%1, M%2, L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "Modul za prepoznavanje glasa RX %1 TX %2 prepoznaj izjavu %3",
    ...
    "ROBOT_RELAY_MODULE": "Modul za relej %1 NC %2",
    "ROBOT_OLED_SET": "OLED postavi veličinu fonta %1",
    "ROBOT_OLED_STRING": "OLED x%1y%2 prikaži niz %3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2 prikaži broj %3",
    "ROBOT_OLED_CLEAR": "Očisti zaslon OLED-a",
...
Blockly.ScratchMsgs.locales["it"] = {
    ...
    "ROBOT_TEMPERATURE": "Temperatura",
    "ROBOT_HUMIDITY": "Umidità relativa",
    ...
    "ROBOT_TRACE_SENSOR_SET": "Impostazione pin sensore di tracciamento (R%1, M%2, L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "Modulo di riconoscimento vocale RX %1 TX %2 riconoscere frase %3",
    ...
    "ROBOT_RELAY_MODULE": "Modulo relè %1 NC %2",
    "ROBOT_OLED_SET": "OLED impostare dimensione carattere %1",
    "ROBOT_OLED_STRING": "OLED x%1y%2 mostra stringa %3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2 mostra numero %3",
    "ROBOT_OLED_CLEAR": "Cancellare schermo OLED",
...
Blockly.ScratchMsgs.locales["nl"] = {
    ...
    "ROBOT_HUMIDITY": "Relatieve vochtigheid",
    ...
    "ROBOT_MQ4_GAS_SENSOR": "MQ-4 gas sensor %1",
    "ROBOT_TRACE_SENSOR_SET": "Traceersensor stel pin in (R%1,M%2,L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "Spraakherkenningsmodule RX %1 TX %2 herken zin %3",
    ...
    "ROBOT_RELAY_MODULE": "Relaismodule %1 NC %2",
    "ROBOT_OLED_SET": "OLED stel lettertypegrootte in op %1",
    "ROBOT_OLED_STRING": "OLED x%1y%2 toon karakterreeks %3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2 toon nummer %3",
    "ROBOT_OLED_CLEAR": "OLED scherm wissen",
...
Blockly.ScratchMsgs.locales["ja"] = {
    ...
    "ROBOT_TRACE_SENSOR_SET": "トレースセンサーのピン設定(R%1,M%2,L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "音声認識モジュール RX%1TX%2で%3を認識する",
    ...
    "ROBOT_RELAY_MODULE": "リレーモジュール%1NC%2",
    "ROBOT_OLED_SET": "OLEDのフォントサイズを設定%1",
    "ROBOT_OLED_STRING": "OLED x%1y%2に文字列%3を表示",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2に数字%3を表示",
    "ROBOT_OLED_CLEAR": "OLED画面をクリア",
...
Blockly.ScratchMsgs.locales["th"] = {
    ...
    "ROBOT_HUMIDITY": "ความชื้นสัมพัทธ์",
    ...
    "ROBOT_TRACE_SENSOR_SET": "ตั้งค่าพินเซ็นเซอร์ติดตาม (R%1, M%2, L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "โมดูลระบุเสียง RX %1 TX %2 ระบุประโยค %3",
    ...
    "ROBOT_RELAY_MODULE": "โมดูลรีเลย์ %1 NC %2",
    "ROBOT_OLED_SET": "ตั้งค่าขนาดตัวอักษร OLED %1",
    "ROBOT_OLED_STRING": "OLED x%1y%2 แสดงตัวอักษร %3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2 แสดงตัวเลข %3",
    "ROBOT_OLED_CLEAR": "ล้างหน้าจอ OLED",
...
Blockly.ScratchMsgs.locales["pl"] = {
    ...
    "ROBOT_TEMPERATURE": "Temperatura",
    "ROBOT_HUMIDITY": "Wilgotność względna",
    ...
    "ROBOT_TRACE_SENSOR_SET": "Ustawienie pinów czujnika śledzenia (R%1, M%2, L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "Moduł rozpoznawania mowy RX %1 TX %2 rozpoznaj frazę %3",
    ...
    "ROBOT_RELAY_MODULE": "Moduł przekaźnika %1 NC %2",
    "ROBOT_OLED_SET": "OLED ustaw rozmiar czcionki %1",
    "ROBOT_OLED_STRING": "OLED x%1y%2 pokaż ciąg znaków %3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2 pokaż liczbę %3",
    "ROBOT_OLED_CLEAR": "Wyczyść ekran OLED",
...
Blockly.ScratchMsgs.locales["pt"] = {
    ...
    "ROBOT_TEMPERATURE": "Temperatura",
    "ROBOT_HUMIDITY": "Umidade relativa",
    ...
    "ROBOT_TRACE_SENSOR_SET": "Definir pinos do sensor de rastreamento (R%1, M%2, L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "Módulo de reconhecimento de voz RX %1 TX %2 reconhecer frase %3",
    ...
    "ROBOT_OLED_STRING": "OLED x%1y%2 mostra string %3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2 mostra número %3",
    "ROBOT_OLED_CLEAR": "Limpar tela OLED",
    "ROBOT_PRINT": "Serial %1 imprimir %2",
...
Blockly.ScratchMsgs.locales["ru"] = {
    ...
    "ROBOT_HUMIDITY": "Относительная влажность",
    ...
    "ROBOT_TRACE_SENSOR_SET": "Настройка пинов датчика трассировки (R%1, M%2, L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "Модуль распознавания речи RX %1 TX %2 распознать фразу %3",
    ...
    "ROBOT_RELAY_MODULE": "Модуль реле %1 NC %2",
    "ROBOT_OLED_SET": "OLED установить размер шрифта %1",
    "ROBOT_OLED_STRING": "OLED x%1y%2 показать строку %3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2 показать число %3",
    "ROBOT_OLED_CLEAR": "Очистить экран OLED",
...
Blockly.ScratchMsgs.locales["tr"] = {
    ...
    "ROBOT_TRACE_SENSOR_SET": "Iz Sensörü pinlerini ayarla (R%1, M%2, L:%3)",
    ...
    "ROBOT_VOICE_RECOGNITION": "Ses Tanıma Modülü RX %1 TX %2 ifadeyi tanı %3",
    ...
    "ROBOT_RELAY_MODULE": "Röle Modülü %1 NC %2",
    "ROBOT_OLED_SET": "OLED yazı tipi boyutunu ayarla %1",
    "ROBOT_OLED_STRING": "OLED x%1y%2 dizesini göster %3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2 sayısını göster %3",
    "ROBOT_OLED_CLEAR": "OLED ekranını temizle",
...
Blockly.ScratchMsgs.locales["zh-cn"] = {
    ...
    "ROBOT_VOICE_RECOGNITION": "语音识别模块 RX%1TX%2识别语句%3",
    ...
    "ROBOT_RELAY_MODULE": "继电器%1NC%2",
    "ROBOT_OLED_SET": "OLED设置字体尺寸%1",
    "ROBOT_OLED_STRING": "OLED x%1y%2显示字符%3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2显示数字%3",
    "ROBOT_OLED_CLEAR": "OLED清空屏幕",
...
Blockly.ScratchMsgs.locales["zh-tw"] = {
    ...
    "ROBOT_TRACE_SENSOR_SET": "巡線傳感器設置管腳(R%1,M%2,L:%3)",
    ...
    "ROBOT_MP3_MODULE_PLAY_OVER": "MP3 RX%1TX%2播放是否停止",
    "ROBOT_VOICE_RECOGNITION": "語音識別模塊 RX%1TX%2識別語句%3",
    ...
    "ROBOT_RELAY_MODULE": "繼電器%1NC%2",
    "ROBOT_OLED_SET": "OLED設置字體尺寸%1",
    "ROBOT_OLED_STRING": "OLED x%1y%2顯示字符%3",
    "ROBOT_OLED_NUMBER": "OLED x%1y%2顯示數字%3",
    "ROBOT_OLED_CLEAR": "OLED清空屏幕",
    "ROBOT_PRINT": "串口%1打印%2",
    "CATEGORY_ROBOTS": "機器人",
}
